...
function Services({ isAuthenticated, setIsAuthenticated }) {
  ...
  const deliveryTypes = [
    { name: 'AVTO EXPRESS', price: 5, days: '12-15', desc: 'Домашний текстиль, Турецкий текстиль', icon: 'truck' },
    { name: 'AVTO EX MARKA', price: 7, days: '12-15', desc: 'Домашний текстиль, Бренд/марка текстиль, Б/У текстиль, Турецкий текстиль', icon: 'truck' },
    { name: 'AVTO ОБУВЬ', price: 7, days: '14-15', desc: 'Турецкое производство обуви (нельзя бренд)', icon: 'truck' },
    { name: 'AVIA U2 MARKA', price: 9, days: '7-8', desc: 'Турецкий текстиль, Бренд/Марка текстиль, Б/У текстиль', icon: 'plane' },
    { name: 'AVIA EX MARKA', price: 11, days: '3-4', desc: 'Домашний текстиль, Турецкий текстиль', icon: 'plane' },
    { name: 'AVIA U2 ОБУВЬ', price: 11, days: '7-8', desc: 'Турецкое производство обуви, Бренд/Марка обувь, Б/У обувь', icon: 'plane' },
  ];
      ...
      <section style={{
        ...
        <div style={{ maxWidth: 1080, margin: '0 auto' }}>
          ...
          <p style={{
            ...
            производства. Стоимость доставки начинается от $5 за килограмм при автомобильной перевозке
            и от $9 при авиадоставке. Сроки доставки составляют от 3 до 15 дней в зависимости от выбранного тарифа.
          </p>
          <p style={{
            fontSize: 15,
            color: '#4B5563',
