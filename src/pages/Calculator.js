      ...
      <section style={styles.ctaSection}>
        <div style={styles.ctaCard}>
          ...
          <div style={{...styles.ctaButtons, ...(isMobile ? {flexDirection: 'column', alignItems: 'stretch'} : {})}}>
            <a href="https://wa.me/905511898289" target="_blank" rel="noopener noreferrer" className="cta-btn-whatsapp" style={{...styles.ctaWhatsappBtn, ...(isMobile ? {width: '100%', justifyContent: 'center', boxSizing: 'border-box'} : {})}}>
