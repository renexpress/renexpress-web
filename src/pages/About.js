        ...
        <div style={styles.container}>
          ...
          <div className="warehouseGrid" style={{...styles.warehouseGrid, gridTemplateColumns: isMobile ? '1fr' : '1fr 1fr', gap: isMobile ? 16 : 28}}>
            ...
            <div style={{...styles.warehouseCard, padding: isMobile ? 20 : 32}}>
              ...
              <div style={styles.warehouseDivider} />
              <p style={styles.warehouseAddr}>WhatsApp: +90 551 189 82 89</p>
              <p style={styles.warehouseDesc}>
      ...
      <section style={styles.ctaSection}>
        <div style={{...styles.ctaCard, padding: isMobile ? '28px 20px' : '48px 40px'}}>
          ...
          <div style={styles.ctaButtons}>
            <a href="https://wa.me/905511898289" target="_blank" rel="noopener noreferrer" className="footer-cta-btn" style={{...styles.ctaWhatsapp, width: isMobile ? '100%' : 'auto'}}>
            ...
            <a href="tel:+905511898289" className="footer-cta-btn" style={{...styles.ctaCall, width: isMobile ? '100%' : 'auto'}}>
