...
function Login({ setIsAuthenticated }) {
  ...
  return (
    <div className="auth-container" style={styles.container}>
      ...
      <style>{`
        .auth-input::placeholder { color: #999999; }
        .auth-input:focus { border-color: ${PRIMARY} !important; box-shadow: 0 0 0 3px rgba(42,171,171,0.15); }
        .auth-submit:hover:not(:disabled) { box-shadow: ${SHADOW.cta}; transform: translateY(-1px); }
        .auth-submit:active:not(:disabled) { transform: translateY(0); }
        .auth-stat-card:hover { border-color: #2AABAB !important; transform: translateY(-2px); }
      ...
      <div className="auth-left auth-left-panel" style={styles.leftSide}>
        ...
        <div style={styles.heroContent}>
          ...
          <h1 style={styles.heroTitle}>
            Доставляем<br />ваш бизнес<br />в <span style={{ color: PRIMARY_TEXT }}>Россию</span>
          </h1>
