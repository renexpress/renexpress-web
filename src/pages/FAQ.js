...
function FAQ({ isAuthenticated, setIsAuthenticated }) {
  ...
  const faqItems = [
    ...
    // Доставка и сроки
    { q: 'Сколько стоит доставка из Турции?', a: 'Стоимость зависит от типа товара и способа доставки. Авто доставка: от $5/кг (AVTO EXPRESS) до $7/кг (AVTO EX MARKA, AVTO ОБУВЬ). Авиа доставка: от $9/кг (AVIA U2 MARKA) до $11/кг (AVIA EX MARKA, AVIA U2 ОБУВЬ). Минимальный вес отправки — 10 кг.', cat: 'Доставка и сроки' },
    { q: 'Какие сроки доставки из Стамбула в Москву?', a: 'Авто доставка занимает 12-15 дней (текстиль и обувь). Авиа доставка: AVIA EX MARKA — 3-4 дня, AVIA U2 MARKA и AVIA U2 ОБУВЬ — 7-8 дней. Точные сроки зависят от загруженности маршрутов и таможенного оформления.', cat: 'Доставка и сроки' },
    ...
    // Типы грузов
    { q: 'Что такое тариф AVTO EXPRESS?', a: 'AVTO EXPRESS — самый доступный тариф по цене $5/кг. Подходит для домашнего текстиля и турецкого текстиля без брендовых маркировок. Срок доставки — 12-15 дней автотранспортом.', cat: 'Типы грузов' },
    { q: 'В чём разница между AVTO EXPRESS и AVTO EX MARKA?', a: 'AVTO EXPRESS ($5/кг) предназначен только для домашнего и турецкого текстиля без брендов. AVTO EX MARKA ($7/кг) включает доставку брендового/маркированного текстиля и б/у текстиля. Сроки доставки одинаковые — 12-15 дней.', cat: 'Типы грузов' },
    { q: 'Можно ли отправить брендовую обувь?', a: 'Да, для брендовой и б/у обуви предусмотрен тариф AVIA U2 ОБУВЬ по цене $11/кг со сроком 7-8 дней. Тариф AVTO ОБУВЬ ($7/кг, 14-15 дней) предназначен только для обуви турецкого производства без брендовых маркировок.', cat: 'Типы грузов' },
